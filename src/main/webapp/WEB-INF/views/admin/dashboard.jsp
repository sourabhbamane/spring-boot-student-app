          ...
          <tbody>
            <c:forEach var="s" items="${studentList}">
              <tr>
                ...
                <td>${s.email}</td>
                <td class="actions">
                  <a class="btn edit" href="${pageContext.request.contextPath}/admin/editStudent/${s.id}">Edit</a>
                  <a class="btn delete" href="${pageContext.request.contextPath}/admin/deleteStudent/${s.id}" onclick="return confirm('Delete this student?')">Delete</a>
                </td>
              </tr>
            </c:forEach>
          </tbody>
